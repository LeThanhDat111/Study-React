...
export const myData = [
	...
	},
	{
		img: pic2,
		title: 'JSX',
		desc: 'Kết hợp HTML và JSX để tạo giao diện rộng và mạnh mẽ',
	},
	{
		img: pic3,
		title: 'Props',
...
export const EXAMPLE = {
	components: {
		title: 'Components',
		desc: 'Thành phần là các khối giao diện tái sử dụng trong React. Chúng được thiết kế độc lập và có thể kết hợp linh hoạt',
